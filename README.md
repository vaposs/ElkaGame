...
### Монетизация:
- Открытия дополнительного места на парковке при просмотре рекламы.
- Реклама для удвоения победных очков каждого уровня (по желанию).
- Реклама при переходе на следущий уровень.
- Реклама при рестарте уровня.
- Постоянные Sticky-баннеры.
